...
resource "aws_security_group_rule" "websg_rules" {
  ...
  cidr_blocks       = var.web_sg_config.rules[count.index].cidr_blocks
...
resource "aws_security_group_rule" "appsg_rules" {
  ...
  cidr_blocks       = var.app_sg_config.rules[count.index].cidr_blocks
...
resource "aws_security_group_rule" "dbsg_rules" {
  ...
  cidr_blocks       = var.db_sg_config.rules[count.index].cidr_blocks
